...
<body>
          ...
          <div class="entreprise-card">
            ...
            <div id="cardprev" class="card-body1">
                ...
                <div class="input-boxs">
                    ...
                    <form action="login2_entreprise.php" method="POST">
                        ...
                        <input class="input-btn" type="button" name="next" value="Next" onclick="swept()" />
                    
                </div>
                <div class="myplace">
                    <p>Vous êtes un livreur ? <a href="../login_livreur/login2_livreur.php">s'inscrire</a></p>
                </div>
            </div>
            <div id="cardnext" class="card-body2">
                <div class="input-boxs">
                    <h1>One More Step !</h1>
                        <input class="input-field" type="text" name="business_name" placeholder="Business name" />
                        ...
                        <input class="input-field" type="text" name="tele" placeholder="Contact Number" />
                        <input class="input-btn" type="submit" name="signup_submit_E" value="S'inscrire" />
                    </form>
                </div>
                <div class="myplace">
                    <p>Vous avez déja un compte ? <a href="../se_connecter/connecter.html">connexion</a></p>
                </div>
            </div>
    ...
    <script src="login2_entreprise_js.js"></script>
</body>
</html>