            ...
            <section id="main">
                <div class="main_card">
                    <div class="sub_main_card">
                        ...
                        <?php $results = mysqli_query($db, "SELECT * FROM users WHERE username LIKE '$username' "); 
                        while ($row = mysqli_fetch_array($results)) { ?>
                           <form method="POST" action="profil.php" >
                               <h1>Nom d'utilisateur : <?php echo $username ?></h1>
                        ...
                        <div class="main_infos">
                               ...
                               <table class="with_margin">
                                ...
                                <tr>
                                    ...
                                    <td>: <input type="text" name="tele" value="<?php echo $row['tele'] ; ?>"></td>
                                </tr>
                                <tr>
                                    <td><img class="max_img" src="./images/adress.png" alt="adresse"></td>
                                    <td><strong>Adresse</strong></td>
                                    <td>: <textarea name="adress" cols="50" rows="1"><?php echo $row['adress']; ?></textarea>
                    ...
                    <div class="infos_card_text">
                        <table class="no_margin">
                            <tr>
                                ...
                                <td><strong>:  </strong><input type="text" name="birthday" value="<?php echo $row['birthday'] ; ?>"></td>
                            </tr>
                            <tr>
                                <td><strong>Expérience</strong></td>
                                <td><strong>:  </strong><input type="text" name="experience" value="<?php echo $row['experience'] ; ?>"></td>
                            </tr>
                            <tr>
                                <td><strong>Prix</strong></td>
                                <td><strong>:  </strong><input type="text" id="livraison" name="price" value="<?php echo $row['price'] ; ?>"></td>
                            </tr>
                        </table> 
                    </div></div>
                <div class="about_card">
                    ...
                    <div class="about_card_text">
                       <textarea name="description" cols="85" rows="5"><?php echo $row['description'] ; ?></textarea>
                        
                       
                    </div>
                </div>
                <div class="but_card" >
                     <input class="input-btn" type="submit" name="update" value="Enregistrer" />
                     </form>
                       <?php } ?>
                     <style>
                         .input-btn {
